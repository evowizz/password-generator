...
public class PasswordProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, PasswordContract.PATH_PASSWORD, PASSWORD);
        return matcher;
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            case PASSWORD: {
                ...
                if ( _id > 0 )
                    returnUri = PasswordContract.PasswordEntry.buildPasswordUri(_id);
                else
        ...
        switch (match) {
            case PASSWORD:
                rowsDeleted = db.delete(
                        PasswordContract.PasswordEntry.TABLE_NAME, selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
    ...
    public int update(
        ...
        switch (match) {
            case PASSWORD:
                rowsUpdated = db.update(PasswordContract.PasswordEntry.TABLE_NAME, values, selection,
                        selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
